...
class MarketNewsAgent(BaseAgent):
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "properties": {
                            ...
                            "summary": {"type": "string", "description": "Brief summary of the news retrieval and status of the save operation."}
                        },
    ...
    def _execute_tool(self, tool_name: str, arguments: Dict[str, Any]) -> str:
        try:
            if tool_name == "fetch_market_news":
                ...
                if not articles:
                    return json.dumps({"status": "failure", "error": "No articles to save"})
                ...
                for item in articles:
                    ...
                    chunks = self.text_processor.process_and_embed(content, metadata=metadata)
                    all_chunks.extend(chunks)
                
                if all_chunks:
                    self.vector_db.upsert_chunks(all_chunks)
                
                return json.dumps({"status": "success", "saved_articles": len(articles)})
    ...
    async def execute(self, user_query: str, step_number: int = 0) -> AgentResponse:
        messages = [
            Message(role="system", content=prompt_manager.get_prompt("market_news.system")),
            ...
            while current_turn < max_turns:
                ...
                if response_msg.tool_calls:
                    ...
                    return AgentResponse(
                        ...
                        errors=["Final output was text-only, not structured JSON via submit_news_results tool."]
                    )
