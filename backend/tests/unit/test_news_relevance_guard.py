...
def test_relevance_guard_matches_ticker_frequency():
    ...
    article = {"title": "Market Trends 2024", "content": content}
...
def test_relevance_guard_handles_case_sensitivity_and_whole_words():
    ...
    article = {"title": "AAPLE is not a ticker", "content": "Just some random text."}
    assert is_article_relevant(article, ticker="AAPL") is False

    # Case insensitivity
    article_lower = {"title": "aapl update", "content": "market news."}
