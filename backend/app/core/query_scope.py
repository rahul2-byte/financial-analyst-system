...
def normalize_research_scope(query: str) -> str:
    ...
    has_one_year_window = "one year" in lowered or "1 year" in lowered or "last year" in lowered
    has_explicit_dimensions = any(marker in lowered for marker in EXPLICIT_DIMENSION_MARKERS)
